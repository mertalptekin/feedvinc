...
namespace FeedVinc.BLL.Services
{
    public class UnitOfWork:IUnitOfWork
    {
        ...
        private BaseRepository<AppUserSecondShare> _appuserSecondShare;

        public BaseRepository<AppUserSecondShare> appuserSecondShare
        {
            get
            {

                return _appuserSecondShare ?? new BaseRepository<AppUserSecondShare>(_context);
            }
        }

        private BaseRepository<ProjectSecondShare> _projectSecondShare;

        public BaseRepository<ProjectSecondShare> projectSecondShare
        {
            get
            {

                return _projectSecondShare ?? new BaseRepository<ProjectSecondShare>(_context);
            }
        }

        private BaseRepository<CommunitySecondShare> _communitySecondShare;

        public BaseRepository<CommunitySecondShare> communitySecondShare
        {
            get
            {

                return _communitySecondShare ?? new BaseRepository<CommunitySecondShare>(_context);
            }
        }

        private BaseRepository<FeedBackSecondShare> _feedbackSecondShare;

        public BaseRepository<FeedBackSecondShare> feedbackSecondShare
        {
            get
            {

                return _feedbackSecondShare ?? new BaseRepository<FeedBackSecondShare>(_context);
            }
        }

        private BaseRepository<LaunchSecondShare> _launchSecondShare;

        public BaseRepository<LaunchSecondShare> launchSecondShare
        {
            get
            {

                return _launchSecondShare ?? new BaseRepository<LaunchSecondShare>(_context);
            }
        }

        private BaseRepository<IdeaSecondShare> _ideaSecondShare;

        public BaseRepository<IdeaSecondShare> IdeaSecondShare
        {
            get
            {

                return _ideaSecondShare ?? new BaseRepository<IdeaSecondShare>(_context);
            }
        }
