...
{
    public class InvestmentNewsSecondShareFactory : SecondShareFactory, IShare, ISharePost
    {
        public InvestmentNewsSecondShareFactory(UnitOfWork service) : base(service)
        {
        }
        ...
        public NotificationShareVM Post(string userID, ShareBaseModel model)
        {
            ...
            var _currentShare = _service.InvestmentNewsShareRepo.FirstOrDefault(x => x.ID == model.PostID);
